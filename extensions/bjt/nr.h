...
typedef struct {
	int *ilob,*iupb,*ncumfq,jdif,nc,minint,nch,ncum,nrad;
} arithcode;
...
typedef struct {
	int *icod,*ncod,*left,*right,nch,nodemax;
} huffcode;
...
void arcmak(int nfreq[], int nchh, int nradd,
	arithcode *acode);
void arcode(int *ich, unsigned char **codep, int *lcode,
	int *lcd, int isign, arithcode *acode);
void arcsum(int iin[], int iout[], int ja,
	int nwk, int nrad, int nc);
void asolve(int n, double b[], double x[], int itrnsp);
...
double factln(int n);
double factrl(int n);
void fasper(double x[], double y[], int n, double ofac, double hifac,
	double wk1[], double wk2[], int nwk, int *nout,
...
void fourfs(FILE *file[5], int nn[], int ndim, int isign);
...
void frprmn(double p[], int n, double ftol, int *iter, double *fret,
	double (*func)(double []), void (*dfunc)(double [], double []));
void ftest(double data1[], int n1, double data2[], int n2,
	double *f, double *prob);
double ftestb(double f, double df1, double df2);	//bjt
...
void hpsel(int m, int n, double arr[], double heap[]);
void hpsort(int n, double ra[]);
void hqr(double **a, int n, double wr[], double wi[]);
void hufapp(int index[], int nprob[], int n,
	int i);
void hufdec(int *ich, unsigned char *code, int lcode,
	int *nb, huffcode *hcode);
void hufenc(int ich, unsigned char **codep, int *lcode,
	int *nb, huffcode *hcode);
void hufmak(int nfreq[], int nchin, int *ilong,
	int *nlong, huffcode *hcode);
...
unsigned short icrc(unsigned short crc, unsigned char *bufptr,
	int len, short jinit, int jrev);
unsigned short icrc1(unsigned short crc, unsigned char onech);
int igray(int n, int is);
void iindexx(int n, long arr[], int indx[]);
...
void ks2d1s(double x1[], double y1[], int n1,
	void (*quadvl)(double, double, double *, double *, double *, double *),
	double *d1, double *prob);
void ks2d2s(double x1[], double y1[], int n1, double x2[], double y2[],
	int n2, double *d, double *prob);
...
void linbcg(int n, double b[], double x[], int itol, double tol,
...
void miser(double (*func)(double []), double regn[], int ndim, int npts,
...
int polintb(double xa[], double ya[], int n, double x, double *y, double *dy);	// bjt
void powell(double p[], double **xi, int n, double ftol, int *iter, double *fret,
	double (*func)(double []));
void predic(double data[], int ndata, double d[], int m, double future[], int nfut);
double probks(double alam);
void psdes(int *lword, int *irword);
...
void quadct(double x, double y, double xx[], double yy[], int nn,
...
void rkqs(double y[], double dydx[], int n, double *x,
	...
	void (*derivs)(double, double [], double []));
void rlft3(double ***data, double **speq, int nn1,
...
// * conflict with linux in /usr/include/sys/select.h:105
// double select(int k, int n, double arr[]);
//
double selip(int k, int n, double arr[]);
...
int splintb(double xa[], double ya[], double y2a[], int n, double x, double *y);	// bjt
...
void sprsin(double **a, int n, double thresh, int nmax, double sa[],
	int ija[]);
void sprspm(double sa[], int ija[], double sb[], int ijb[],
	double sc[], int ijc[]);
void sprstm(double sa[], int ija[], double sb[], int ijb[],
	double thresh, int nmax, double sc[], int ijc[]);
void sprstp(double sa[], int ija[], double sb[], int ijb[]);
void sprstx(double sa[], int ija[], double x[], double b[],
	int n);
...
int svdcmpb(double **a, int m, int n, double w[], double **v);	// bjt
void svdfit(double x[], double y[], double sig[], int ndata, double a[],
	int ma, double **u, double **v, double w[], double *chisq,
	void (*funcs)(double, double [], int));
int svdfitb(double x[], double y[], double sig[], int ndata, double a[],
	int ma, double **u, double **v, double w[], double *chisq,
	void (*funcs)(double, double [], int));		// bjt
void svdvar(double **v, int ma, double w[], double **cvm);
double ***tensor(long ndepth, long nrow, long ncol);
...
void ttest(double data1[], int n1, double data2[], int n2,
	double *t, double *prob);
double ttestb(double t, double df);	// bjt
void tutest(double data1[], int n1, double data2[], int n2,
	double *t, double *prob);
...
void vegas(double regn[], int ndim, double (*fxn)(double [], double), int init,
	int ncall, int itmx, int nprn, double *tgral, double *sd,
	double *chi2a);
